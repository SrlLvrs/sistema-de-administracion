<template>
    ...
    <label :for="id" class="btn btn-outline btn-success" @click="crearPedido()">
...
export default {
    ...
    methods: {
        ...
        crearPedido() {
            ...
            let url = `https://nuestrocampo.cl/demo/pedidos/create.php?id_cliente=${idc}&hora_creacion=${hmysql}&fecha_reparto=${hmysql}`
        ...
        crearPedido_Producto() {
            ...
            let url = `https://nuestrocampo.cl/demo/pedidos/update.php?id=${id}&idcliente=${idc}&estado=${e}&pagado=${p}&mediopago=${m}&fechaentrega=${fmysql}`
