<template>
    ...
    <label :for="label" class="btn btn-outline btn-error mr-2">
    ...
    <div class="modal" role="dialog">
        <div class="modal-box modal-pedido">
            ...
            <div>
                ...
                <p class="py-4">Estás a punto de eliminar este usuario, ¿estás seguro?</p>

                <!-- Acciones -->
                <div class="modal-action">
                    <label :for="label" class="btn">No!</label>
                    <button class="btn btn-outline btn-error" @click="eliminarUsuario()">
