<template>
    ...
    <label :for="label" class="btn btn-outline btn-info mr-2" @click="leerDetallePedido()">
    ...
    <div class="modal" role="dialog">
        <div class="modal-box modal-pedido metamodal">
            <h3 class="text-lg font-bold mb-2 text-center">Detalle del pedido automático {{ id }}</h3>
            ...
            <div v-else>
                <div>
                    ...
                    <!-- Esta vista es una versión mínima del Detalle Pedido Original. 
                        Para insertar otros valores, revisar el endpoint -->
...
export default {
    ...
    methods: {
        ...
        leerDetallePedido() {
            let idp = this.id;
            let url = `https://nuestrocampo.cl/api/pedidos/read-detail-auto.php?id=${idp}`
