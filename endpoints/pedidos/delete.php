...
if (!empty($id)) {
    ...
    $query = "UPDATE pedidos SET Visible = 0 WHERE ID = :id";
    ...
    if ($stmt->execute()) {
        ...
        echo json_encode(array("message" => "El pedido " . $id . " fue eliminado."));
    } else {
        ...
        echo json_encode(array("message" => "No fue posible eliminar el pedido. Revisa el log para más información."));
    }
} else {
